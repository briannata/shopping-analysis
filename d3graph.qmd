...
<p>We used <a href="./scripts/d3dataparsing.py">a Python script</a> to group and parse the data so that we could create our grouped bar chart, showing the top five Amazon product categories for each of the different demographic groups.</p>
